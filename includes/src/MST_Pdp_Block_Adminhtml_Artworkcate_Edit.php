...
class MST_Pdp_Block_Adminhtml_Artworkcate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if (Mage::registry('artworkcate_data') && Mage::registry('artworkcate_data')->getId()) {
            return Mage::helper('pdp')->__("Edit category '%s'", $this->htmlEscape(Mage::registry('artworkcate_data')->getTitle()));
        } else {
