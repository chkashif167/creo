...
class Tentura_Ngroups_Block_Adminhtml_Oldsubscriber_Gridreload extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        $this->setTemplate('ngroups/oldcustomers_reload.phtml');
    }
