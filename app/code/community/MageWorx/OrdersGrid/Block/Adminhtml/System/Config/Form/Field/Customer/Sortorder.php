...
class MageWorx_OrdersGrid_Block_Adminhtml_System_Config_Form_Field_Customer_Sortorder extends
    Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $ajaxUrl = Mage::getUrl('adminhtml/mageworx_ordersgrid/savecustomersortorder');
        $script = <<<SCRIPT
jQuery("#$id").multisortable({
    ...
    stop: function(e){
            ...
            setCustomerColumnsData(data);
        }

});

function setCustomerColumnsData(data) {
...
STYLESHEET;
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        if ($values = $element->getValues()) {
            ...
            $positions = $helper->getCustomerGridColumnsSortOrder();
