 ...
 * 
 */
class Clarion_FeaturedProduct_Block_Sidebar_Right_Sidebar extends Mage_Catalog_Block_Product_Abstract
{  
    /**
    ...
    {
       $pager = $this->getChild('featured.product.right.sidebar.pager');
        if ($pager) {
    ...
    {
        $currentPage ='';
        $listBlock = $this->getLayout()->getBlock('featured.product.right.sidebar');
        if ($listBlock) {
