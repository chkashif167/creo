 ...
 */
class Clarion_ReviewReminder_Block_Adminhtml_Closedreminder extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        /*both these variables tell magento the location of our Grid.php(grid block) file.
         * $this->_blockGroup.'/' . $this->_controller . '_grid'
         * i.e  clarion_reviewreminder/adminhtml_closedreminder_grid
        ...
        $this->_headerText = Mage::helper('clarion_reviewreminder')->__('Closed Reminders');
