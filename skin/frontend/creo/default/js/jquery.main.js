        ...
        var t, o = "mCustomScrollbar", a = "mCS", n = ".mCustomScrollbar", i = {setTop: 0, setLeft: 0, axis: "y", scrollbarPosition: "inside", scrollInertia: 950, autoDraggerLength: !0, alwaysShowScrollbar: 0, snapOffset: 0, mouseWheel: {enable: !0, scrollAmount: "auto", axis: "y", deltaFactor: "auto", disableOver: ["select", "option", "keygen", "datalist", "textarea"]}, scrollButtons: {scrollType: "stepless", scrollAmount: "auto"}, keyboard: {enable: !0, scrollType: "stepless", scrollAmount: "auto"}, contentTouchScroll: 25, advanced: {autoScrollOnFocus: "input,textarea,select,button,datalist,keygen,a[tabindex],area,object,[contenteditable='true']", updateOnContentResize: !0, updateOnImageLoad: !0}, theme: "light", callbacks: {onTotalScrollOffset: 0, onTotalScrollBackOffset: 0, alwaysTriggerOffsets: !0}}, r = 0, l = {}, s = window.attachEvent && !window.addEventListener ? 1 : 0, c = !1, d = ["mCSB_dragger_onDrag", "mCSB_scrollTools_onDrag", "mCS_img_loaded", "mCS_disabled", "mCS_destroyed", "mCS_no_scrollbar", "mCS-autoHide", "mCS-dir-rtl", "mCS_no_scrollbar_y", "mCS_no_scrollbar_x", "mCS_y_hidden", "mCS_x_hidden", "mCSB_draggerContainer", "mCSB_buttonUp", "mCSB_buttonDown", "mCSB_buttonLeft", "mCSB_buttonRight"], u = {init: function (t) {
            ...
            function t(t, a) {
                if (V(o), !A(o, t.target)) {
                    ...
                    "y" === d && !n.overflowed[0] || "x" === d && !n.overflowed[1] || (i.mouseWheel.invert && (g = -g), i.mouseWheel.normalizeDelta && (g = 0 > g ? -1 : 1), (g > 0 && 0 !== m || 0 > g && m !== p || i.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()), Q(o, (h - g * f).toString(), {dir: d}))
                }
            }
            ...
            r.bind("focusin." + i, function () {
                ...
                o.is(n.advanced.autoScrollOnFocus) && (V(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = a ? (i + 17) * a : 0, t[0]._focusTimeout = setTimeout(function () {
                    ...
                    "x" === n.axis || s[0] || Q(t, e[0].toString(), {dir: "y", scrollEasing: "mcsEaseInOut", overwrite: c, dur: i}), "y" === n.axis || s[1] || Q(t, e[1].toString(), {dir: "x", scrollEasing: "mcsEaseInOut", overwrite: c, dur: i})
                }, t[0]._focusTimer))
            })
        }, H = function () {
...
function popupValidation()
{
    ...
    if (jQuery('.option-container').find('.has-swatches').length > 0) {
		...
		// size
        if (jQuery('.option-container').find('#swatches-options-132').find('li').find('a.selected').length <= 0) {
            if (errors.length >= 1) {
        ...
        }else if (jQuery('.option-container').find('#swatches-options-134').find('li').find('a.selected').length <= 0) { 
            errors = "Please make sure to select style";
        }else if (jQuery('.option-container').find('#swatches-options-159').find('li').find('a.selected').length <= 0) {
            errors = "Please make sure to select tshirt color";
        }else if (jQuery('.option-container').find('#swatches-options-160').find('li').find('a.selected').length <= 0) {
            errors = "Please make sure to select polo color";
        }else if (jQuery('.option-container').find('#swatches-options-156').find('li').find('a.selected').length <= 0) {
