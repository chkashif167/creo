...
jQuery(window).load(function(){
    jQuery('.product-swatches-container').find('#swatches-options-176 li:first-child').find('a').click();
...
jQuery(document).ready(function($) {
        jQuery("#options_17_text,#options_18_text,#options_19_text,#options_20_text").attr("maxlength","1");
