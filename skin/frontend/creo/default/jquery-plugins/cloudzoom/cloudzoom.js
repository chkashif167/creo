...
(function ($) {
    ...
    function CloudZoom(jWin, opts) {
		...
		*/
		    ...
		    /* added by MangoExtensions to Fix Background size */
		    lens.css( "background-size",   jWin.width() + "px " + jWin.height() + "px"    );
		    ...
		    /* added by MangoExtensions to Fix Background size */
		    softFocus.css( "background-size",   jWin.width() + "px " + jWin.height() + "px"    );
                    noTrans = true;
